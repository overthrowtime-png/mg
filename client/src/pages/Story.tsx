  ...
  return <main className="story-page min-h-screen overflow-x-hidden bg-[#f5f1e7] text-[#1f3b2c]">
    <header className={`story-site-header fixed inset-x-0 top-0 z-40 border-b border-white/[0.07] text-[#f5f1e7] transition-[height,background-color,backdrop-filter] duration-[280ms] ease-out ${isHeaderCompact ? "h-[68px] bg-[#173527]/92 backdrop-blur-md lg:h-[72px]" : "h-[72px] bg-[#173527] lg:h-[90px]"}`}>
      <div className="mx-auto grid h-full w-full max-w-[1320px] grid-cols-[auto_1fr_auto] items-center gap-5 px-5 sm:px-8 lg:px-10">
        ...
        <nav className="hidden items-center justify-self-center gap-12 text-[14px] font-medium tracking-[0.015em] lg:flex" aria-label={copy.ui.storyNavigation}>
    ...
    <section className="story-hero relative flex min-h-[74svh] items-end overflow-hidden bg-[#173527] text-[#f5f1e7] lg:min-h-[82vh]">
      ...
      <div className="pointer-events-none absolute right-[8%] top-1/2 hidden -translate-y-1/2 items-center gap-4 lg:flex" aria-hidden="true">
        <span className="font-primary text-[clamp(2.8rem,5.6vw,5.6rem)] font-normal leading-none text-[#a7c19d]/10">01</span>
      ...
      <div className="relative mx-auto grid w-full max-w-7xl gap-10 px-5 pb-14 pt-32 sm:px-8 sm:pb-16 sm:pt-36 lg:grid-cols-[1.15fr_0.85fr] lg:items-end lg:px-12 lg:pb-18 lg:pt-28">
        <div className="max-w-2xl">
          <p className="story-hero-reveal text-[11px] font-semibold uppercase tracking-[0.08em] text-[#c9af77]">{story.heroChapter}</p>
          <p className="story-hero-reveal mt-3 text-[11px] font-semibold uppercase tracking-[0.08em] text-[#c9af77]/75">{story.heroEyebrow}</p>
          <h1 className="story-hero-reveal mt-6 max-w-[780px] type-h1"><span className="lg:whitespace-nowrap">{story.heroTitle}</span><br /><span className="text-[#c9af77]">{story.heroTitleAccent}</span></h1>
          <p className="story-hero-reveal mt-7 max-w-md type-body-lg text-[#f5f1e7] sm:text-xl">{story.heroLead}</p>
          <p className="story-hero-reveal mt-5 max-w-md text-[15px] leading-8 text-[#d9ddcf]">{story.heroBody}</p>
        </div>
        <span className="story-hero-reveal hidden self-end justify-self-end text-[11px] font-semibold uppercase tracking-[0.08em] text-[#c9af77] lg:block">{copy.ui.scrollToExplore} <ArrowDown className="mt-3" size={15} /></span>
      </div>
    </section>

    <section className="bg-[#f5f1e7] px-5 py-24 sm:px-8 lg:px-12 lg:py-36"><div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-[0.75fr_1.25fr] lg:items-start"><div data-story-reveal className="story-reveal"><p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-[#ad8e50]">{story.whyEyebrow}</p><h2 className="mt-5 type-h2">{story.whyTitle}</h2></div><div data-story-reveal className="story-reveal max-w-2xl lg:pt-12"><p className="type-body-lg text-[#1f3b2c]">{story.whyBody}</p><p className="mt-8 max-w-lg text-[15px] leading-8 text-[#697363]">{story.whyClosing}</p></div></div></section>

    <section className="story-dark-chapter relative isolate overflow-hidden bg-[#1f3b2c] px-5 py-24 text-[#f5f1e7] sm:px-8 lg:px-12 lg:py-36"><div className="absolute inset-0 bg-cover bg-center opacity-80 lg:opacity-100" style={{ backgroundImage: "url(\"/bg-s01-gon-bung-nhe-tenh.png\")", backgroundPosition: "center" }} aria-hidden="true" /><div className="absolute inset-0 bg-gradient-to-r from-[#1f3b2c]/96 via-[#1f3b2c]/78 to-[#1f3b2c]/34" aria-hidden="true" /><div className="absolute inset-0 bg-gradient-to-t from-[#1f3b2c]/58 via-transparent to-[#1f3b2c]/18" aria-hidden="true" /><div className="relative mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1fr_0.8fr] lg:items-end"><div data-story-reveal className="story-reveal"><p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-[#c9af77]">{story.greenTitle}</p><h2 className="mt-6 max-w-3xl type-h2">Morning<br /><span className="text-[#c9af77]">Green.</span></h2></div><p data-story-reveal className="story-reveal max-w-md text-[15px] leading-8 text-[#cbd4c4]">{story.greenBody}</p></div></section>

    <section className="relative overflow-hidden bg-[#e8e4d7]"><div className="story-image-break min-h-[58vh] bg-cover bg-center" style={{ backgroundImage: "linear-gradient(rgba(245,241,231,.04), rgba(23,53,39,.2)), url('/bottle-stage-ingredients.png')" }} role="img" aria-label={story.ingredientCaption} /><div className="pointer-events-none absolute inset-x-0 bottom-0 h-56 bg-gradient-to-t from-[#173527]/80 via-[#173527]/20 to-transparent" aria-hidden="true" /><div className="absolute inset-x-5 bottom-6 max-w-2xl text-[#f5f1e7] sm:inset-x-8 lg:inset-x-12"><p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-[#c9af77]">{story.freshnessEyebrow}</p><h2 className="mt-3 max-w-3xl type-h3">{story.freshnessTitle}</h2><p className="mt-3 max-w-md text-[12px] leading-6 text-[#d9ddcf]">{story.ingredientCaption}</p></div></section>

    <section className="bg-[#f5f1e7] px-5 py-20 sm:px-8 lg:px-12 lg:py-28"><div className="mx-auto max-w-7xl"><div data-story-reveal className="story-reveal flex flex-col justify-between gap-8 border-b border-[#1f3b2c]/14 pb-10 lg:flex-row lg:items-end"><div><p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-[#ad8e50]">{story.processEyebrow}</p><h2 className="mt-5 max-w-3xl type-h2">{story.processTitle}</h2></div><p className="max-w-md text-[15px] leading-8 text-[#697363]">{story.freshnessBody}</p></div><div className="mt-14 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">{story.process.map((item) => <div key={item.number} data-story-reveal className="story-reveal border-t border-[#1f3b2c]/14 pt-5"><span className="font-ui text-3xl font-medium text-[#ad8e50]/80">{item.number}</span><h3 className="mt-8 text-[11px] font-semibold uppercase tracking-[0.08em] text-[#1f3b2c]">{item.title}</h3><p className="mt-4 text-[14px] leading-7 text-[#697363]">{item.body}</p></div>)}</div></div></section>

    <section className="bg-[#e8e4d7] px-5 py-20 sm:px-8 lg:px-12 lg:py-28"><div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center"><div data-story-reveal className="story-reveal border-t border-[#1f3b2c]/14 pt-6"><div className="space-y-4">{story.principles.map((principle, index) => <div key={principle} className="flex items-baseline gap-4 border-b border-[#1f3b2c]/14 pb-4"><span className="shrink-0 font-ui text-xl font-medium text-[#ad8e50]/80">0{index + 1}</span><span className="shrink-0 whitespace-nowrap type-h3 text-[#1f3b2c]">{principle}</span></div>)}</div></div><div data-story-reveal className="story-reveal lg:pl-8"><p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-[#ad8e50]">{story.nothingEyebrow}</p><h2 className="mt-5 max-w-xl type-h2">{story.nothingTitle}</h2><p className="mt-8 max-w-md text-[15px] leading-8 text-[#697363]">{story.nothingBody}</p></div></div></section>

    <section className="bg-[#f5f1e7] px-5 py-24 sm:px-8 lg:px-12 lg:py-36"><div className="mx-auto max-w-7xl"><div className="max-w-3xl" data-story-reveal><p className="story-reveal text-[11px] font-semibold uppercase tracking-[0.08em] text-[#ad8e50]">{story.realEyebrow}</p><h2 className="story-reveal mt-5 type-h2">{story.realTitle}</h2><p className="story-reveal mt-8 max-w-xl text-[15px] leading-8 text-[#697363]">{story.realBody}</p></div><div className="mt-14 grid gap-8 border-t border-[#1f3b2c]/14 pt-8 md:grid-cols-3">{story.moments.map((moment, index) => <article key={moment.time} data-story-reveal className="story-reveal"><div className={`relative aspect-[1.15] overflow-hidden ${index === 0 ? "bg-[#e8ead9]" : index === 1 ? "bg-[#e8e4d7]" : "bg-[#e2e8df]"}`}><img src={moment.image} alt={moment.title} loading="lazy" className="h-full w-full object-contain object-center p-2 transition duration-700 hover:scale-[1.02] sm:p-3" /></div><p className="mt-5 font-ui text-3xl font-medium text-[#ad8e50]">{moment.time}</p><h3 className="mt-4 text-[11px] font-semibold uppercase tracking-[0.08em] text-[#1f3b2c]">{moment.title}</h3><p className="mt-3 max-w-xs text-[14px] leading-7 text-[#697363]">{moment.body}</p></article>)}</div></div></section>

    <section className="bg-[#f5f1e7] px-5 py-20 sm:px-8 lg:px-12 lg:py-32"><div data-story-reveal className="story-reveal mx-auto max-w-7xl"><p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-[#ad8e50]">{story.beliefEyebrow}</p><div className="mt-6 grid gap-10 lg:grid-cols-[1fr_1fr] lg:items-end lg:gap-16"><h2 className="max-w-2xl font-primary text-[clamp(1.8rem,3.2vw,3.5rem)] font-normal leading-[1.12] tracking-[0.005em] text-[#1f3b2c] text-balance">{renderBeliefTitle(locale, story.beliefTitle)}</h2><p className="max-w-2xl font-primary text-[clamp(1.8rem,3.2vw,3.5rem)] font-normal leading-[1.12] tracking-[0.005em] text-[#1f3b2c] text-balance lg:justify-self-end">{renderBeliefBody(locale, story.beliefBody)}</p></div></div></section>
