...
export default function Story() {
  ...
  return <main className="story-page min-h-screen overflow-x-hidden bg-[#f5f1e7] text-[#1f3b2c]">
    ...
    <section className="bg-[#f5f1e7] px-5 py-20 sm:px-8 lg:px-12 lg:py-32"><div data-story-reveal className="story-reveal mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-end lg:gap-16"><div><p className="text-[9px] font-semibold uppercase tracking-[0.28em] text-[#ad8e50]">{story.beliefEyebrow}</p><h2 className="mt-6 max-w-4xl font-serif text-[clamp(1.8rem,3.2vw,3.5rem)] font-normal leading-[1.12] tracking-[0.005em] text-[#1f3b2c]">{story.beliefTitle}</h2></div><p className="max-w-xl font-serif text-[clamp(1.8rem,3.2vw,3.5rem)] font-normal leading-[1.12] tracking-[0.005em] text-[#1f3b2c] lg:justify-self-end">{story.beliefBody}</p></div></section>
