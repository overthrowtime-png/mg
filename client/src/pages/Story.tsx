...
export default function Story() {
  ...
  return <main className="story-page min-h-screen overflow-x-hidden bg-[#f5f1e7] text-[#1f3b2c]">
    ...
    <section className="bg-[#f5f1e7] px-5 py-24 sm:px-8 lg:px-12 lg:py-36"><div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-[0.75fr_1.25fr] lg:items-start"><div data-story-reveal className="story-reveal"><p className="text-[9px] font-semibold uppercase tracking-[0.28em] text-[#ad8e50]">{story.whyEyebrow}</p><h2 className="mt-5 font-serif text-[clamp(2.1rem,4.2vw,4.2rem)] font-normal leading-[1.16] tracking-[0.005em]">{story.whyTitle}</h2></div><div data-story-reveal className="story-reveal max-w-2xl lg:pt-12"><p className="font-ui text-[clamp(1.25rem,2.1vw,2.15rem)] leading-[1.22] tracking-[0.003em] text-[#1f3b2c]">{story.whyBody}</p><p className="mt-8 max-w-lg text-[15px] leading-8 text-[#697363]">{story.whyClosing}</p></div></div></section>
