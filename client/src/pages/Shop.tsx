...
// Keep the original Shop design and use S01's visible bottle height as the reference.
// Only the inline bottle transform is normalized; source images and surrounding layout stay unchanged.
